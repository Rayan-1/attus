                                ...
                                <v-form ref="form" v-model="valid">
                                    <v-container>
                                        <v-row>
                                            ...
                                            <v-col cols="12">
                                                <v-text-field v-model="usuario.senha" :counter="10" :rules="senhaRules"
                                                    label="Senha" hide-details required></v-text-field>
                                            </v-col>
    ...
    methods: {
        async login() {
            if(this.$refs.form.validate()){
                ...
                await axios.post("http://localhost:8080/api/login",null ,{
                    params:{
